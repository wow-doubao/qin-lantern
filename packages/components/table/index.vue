    ...
    >
      ...
      <!-- <el-table-column label="qwe">
        ...
        >
          <el-table-column
            v-bind="item"
            :fixed="greaterOrEqual? item?.fixed: false"
          >
            <template
              v-if="item?.slot"
              #default="slotProps"
...
import { ClickOutside as vClickOutside, ElTable, ElTableColumn, ElButton, ElPopover, ElTree } from 'element-plus'
...
const handleCheckChange = (data: TableLabel) => {
